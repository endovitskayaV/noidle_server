            ...
            <div class="row">
                <div class="col s12 m4">
                    <div class="icon-block">
                        ...
                        <p class="light">Plugin measures your activity and provide statistics in vivid and clear way on
                            the
                            website, toolwindow.
                ...
                <div class="col s12 m4">
                    <div class="icon-block">
                        ...
                        <p class="light">You can create a team to be able to get your colleagues achievements and
                            realise
