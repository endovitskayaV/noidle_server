            ...
            <div class="card horizontal">
                <div class="card-stacked">
                    <div class="card-content">
                        <p class="center-align"><span>${errorMessage}</span></p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <#list teams as team>
                                    <#if selectedTeamId??>
                                        ...
                                        <#else>
                                            <p>
                                                <label>
                                                    <input name="groupTeam" type="radio" class="with-gap"
                                                           id="${team.id}"/>
                                                    <span>${team.name}</span>
                                                </label>
                                            </p>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            ...
                            <#if statistics["timeper_life"]??>
                                <p><span><i>overall</i>:&emsp;</span><span><b>${statistics["timeper_life"]}</b></span>
                                </p>
                            </#if>
                            <#if statistics["timecontinuous_per_life"]??>
                                <p>
                                    <span><i>max continuous</i>:&emsp;</span><span><b>${statistics["timecontinuous_per_life"]}</b></span>
                                </p>
                            </#if>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            ...
                            <#if statistics["symbolcontinuous_per_day"]??>
                                <p>
                                    <span><i>max continuous</i>:&emsp;</span><span><b>${statistics["symbolcontinuous_per_day"]}</b></span>
                                </p>
                            </#if>
                            <#if statistics["symbolper_life"]??>
                                <p><span><i>today</i>:&emsp;</span><span><b>${statistics["symbolper_life"]}</b></span>
                                </p>
                            </#if>
                            <#if statistics["symbolcontinuous_per_life"]??>
                                <p>
                                    <span><i>max continuous</i>:&emsp;</span><span><b>${statistics["symbolcontinuous_per_life"]}</b></span>
                                </p>
                            </#if>
                        </div>
                    </li>
