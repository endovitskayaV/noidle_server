...
values  (1, 'time', 'per_day', 1, '', 600000), --10m
        (2, 'symbol', 'per_day', 1, '', 50),

--         (3, 'time', 'per_day', 2, '', 216000000), --1h
--         (4, 'symbol', 'per_day', 2, '', 150),
--         (5, 'time', 'continuous_per_day', 2, '', 3600000), --1m
--         (6, 'symbol', 'continuous_per_day', 2, '', 100),

        (7, 'time', 'per_day', 2, '', 7200000), --2h
        (9, 'time', 'continuous_per_day', 2, '', 300000), --5m
        (8, 'symbol', 'per_day', 2, '', 300),
        (10, 'symbol', 'continuous_per_day', 2, '', 100),
        ...
        (17, 'time', 'per_day', 3, '', 10800000), --3h
        (19, 'time', 'continuous_per_day', 3, '', 420000), --7m
        (18, 'symbol', 'per_day', 3, '', 500),
        (20, 'symbol', 'continuous_per_day', 3, '', 150),
        ...
        (30, 'time', 'per_day', 4, '', 14100000), --4h
        (32, 'time', 'continuous_per_day', 4, '', 480000), --8m
        (31, 'symbol', 'per_day', 4, '', 600),
        (33, 'symbol', 'continuous_per_day', 4, '', 200),
        ...
        (48, 'time', 'per_day', 5, '', 18000000), --5h
        (50, 'time', 'continuous_per_day', 4, '', 540000), --9m
        (49, 'symbol', 'per_day', 5, '', 610),
        (51, 'symbol', 'continuous_per_day', 4, '', 300),
        ...
        (69, 'time', 'per_life', 6, '', 32400000), --9h
        (71, 'time', 'continuous_per_day', 6, '', 600000), --10m
        (90, 'lang_time', 'per_day', 6, 'Java', 120000), --2m
        (70, 'symbol', 'per_day', 6, '', 910),
        (72, 'symbol', 'continuous_per_day', 6, '', 400),
        ...
        (92, 'time', 'per_life', 7, '', 36000000), --10h
        (94, 'time', 'continuous_per_life', 7, '', 1080000), --13m
        (113, 'lang_time', 'per_life', 7, 'Java', 1800000), --30m
        (93, 'symbol', 'per_life', 7, '', 2000),
        (95, 'symbol', 'continuous_per_life', 7, '', 500),
        ...
        (115, 'time', 'per_life', 8, '', 64800000), --13h
        (117, 'time', 'continuous_per_life', 8, '', 840000), --14m
        (122, 'lang_time', 'per_life', 8, 'Java', 108000000), --3h
        (116, 'symbol', 'per_life', 8, '', 2500),
        (118, 'symbol', 'continuous_per_life', 8, '', 510),
        ...
        (124, 'time', 'per_life', 9, '', 72000000), --20h
        (125, 'symbol', 'per_life', 9, '', 5500),
        (126, 'exec', 'per_life', 9, 'successful', 49),
        (127, 'exec', 'per_life',  9, 'failed', 36),
        (128, 'commit', 'per_life', 9, 'successful', 34),

        (129, 'time', 'per_life', 10, '', 90000000), --25h
        (134, 'time', 'continuous_per_day', 10, '', 900000), --15m
        (130, 'symbol', 'per_life', 10, '', 5800),
        (135, 'symbol', 'continuous_per_day', 10, '', 610),
