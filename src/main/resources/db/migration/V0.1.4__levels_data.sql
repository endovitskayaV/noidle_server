...
values  (1, 'time', 'per_day', 1, null, 600000), --10m
...
--         (6, 'symbol', 'continuous_per_day', 2, null, 100),
        ...
        (7, 'time', 'per_day', 2, null, 7200000), --2h
        (9, 'time', 'continuous_per_day', 2, null, 300000), --5m
        ...
        (17, 'time', 'per_day', 3, null, 10800000), --3h
        (19, 'time', 'continuous_per_day', 3, null, 420000), --7m
        ...
        (30, 'time', 'per_day', 4, null, 14100000), --4h
        (32, 'time', 'continuous_per_day', 4, null, 480000), --8m
        ...
        (48, 'time', 'per_day', 5, null, 18000000), --5h
        (50, 'time', 'continuous_per_day', 4, null, 540000), --9m
        ...
        (69, 'time', 'per_life', 6, null, 32400000), --9h
        (71, 'time', 'continuous_per_day', 6, null, 600000), --10m
        ...
        (92, 'time', 'per_life', 7, null, 36000000), --10h
        (94, 'time', 'continuous_per_life', 7, null, 1080000), --13m
        ...
        (115, 'time', 'per_life', 8, null, 64800000), --13h
        (117, 'time', 'continuous_per_life', 8, null, 840000), --14m
        ...
        (124, 'time', 'per_life', 9, null, 72000000), --20h
        ...
        (129, 'time', 'per_life', 10, null, 90000000), --25h
        (134, 'time', 'continuous_per_day', 10, null, 900000), --15m
