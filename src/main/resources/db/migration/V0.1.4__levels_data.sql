...
values  (1, 'time', 'per_day', 1, null, 1000 * 60 * 60* 10),
        (2, 'symbol', 'per_day', 1, null, 50),

        (3, 'time', 'per_day', 2, null, 1000 * 60 * 60 * 60),
        (4, 'symbol', 'per_day', 2, null, 150),
        (5, 'time', 'continuous_per_day', 2, null, 1000 * 60 * 60),
        (6, 'symbol', 'continuous_per_day', 2, null, 100),

        (7, 'time', 'per_day', 2, null, 1000 * 60 * 60 * 60 * 1),
        (8, 'symbol', 'per_day', 2, null, 300),
        (9, 'time', 'continuous_per_day', 2, null, 1000 * 60 * 60 * 5),
        ...
        (17, 'time', 'per_day', 3, null, 1000 * 60 * 60 * 60 * 2),
        (18, 'symbol', 'per_day', 3, null, 500),
        (19, 'time', 'continuous_per_day', 3, null, 1000 * 60 * 60 * 7),
        ...
        (30, 'time', 'per_day', 4, null, 1000 * 60 * 60 * 60 * 3),
        (31, 'symbol', 'per_day', 4, null, 600),
        (32, 'time', 'continuous_per_day', 4, null, 1000 * 60 * 60 * 8),
        ...
        (48, 'time', 'per_day', 5, null, 1000 * 60 * 60 * 60 * 4),
        (49, 'symbol', 'per_day', 5, null, 610),
        (50, 'time', 'continuous_per_day', 4, null, 1000 * 60 * 60 * 9),
        ...
        (69, 'time', 'per_life', 6, null, 1000 * 60 * 60 * 60 * 9),
        (70, 'symbol', 'per_day', 6, null, 910),
        (71, 'time', 'continuous_per_day', 6, null, 1000 * 60 * 60 * 10),
        ...
        (90, 'lang_time', 'per_day', 6, 'Java', 1000 * 60 * 60 * 2),
        (91, 'lang_symbol', 'per_day', 6, 'Java', 300),

        (92, 'time', 'per_life', 7, null, 1000 * 60 * 60 * 60 * 9),
        (93, 'symbol', 'per_life', 7, null, 2000),
        (94, 'time', 'continuous_per_life', 7, null, 1000 * 60 * 60 * 13),
        ...
        (113, 'lang_time', 'per_life', 7, 'Java', 1000 * 60 * 60 * 30),
        (114, 'lang_symbol', 'per_life', 7, 'Java', 500),

        (115, 'time', 'per_life', 8, null, 1000 * 60 * 60 * 60 * 13),
        (116, 'symbol', 'per_life', 8, null, 2500),
        (117, 'time', 'continuous_per_life', 8, null, 1000 * 60 * 60 * 14),
        ...
        (122, 'lang_time', 'per_life', 8, 'Java', 1000 * 60 * 60 * 60 * 3),
        (123, 'lang_symbol', 'per_life', 8, 'Java', 1500),

        (124, 'time', 'per_life', 9, null, 1000 * 60 * 60 * 60 * 20),
        ...
        (129, 'time', 'per_life', 10, null, 1000 * 60 * 60 * 60 * 25),
        ...
        (134, 'time', 'continuous_per_day', 10, null, 1000 * 60 * 60 * 15),
